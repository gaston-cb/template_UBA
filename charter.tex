...
\begin{enumerate}
	\item Requerimientos funcionales
		\begin{enumerate}
			...
			\item EL software debe permitir la lectura de viento, tensión, corriente y posición angular de la antena en ambos ejes. 
			\item El software realizará un reporte diario a las 5AM con todos los datos almacenados en formato csv.  
...
\label{sec:backlog}
criterio -> quedan espaciados en 2 
	    muy bajo  2
		bajo      3
		medio     5
		alto      7
...
\item Diagramas de software(34 hs): 
	\begin{enumerate}
		...
		\item Diagrama de software para integración de lectura de sensores y control de posición (8hs) . 
...
\item Desarrollo del webserver (200 hs):  
	\begin{enumerate}
		...
		\item Creación de sistema de consulta de estado(25 hs). 
